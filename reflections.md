...
##### ***Italic:*** 
- using  * * or _ _       
    -  ```js * single asterisks at the beginning and end of text creates italic text * or _ using single underscore at the beginning and end of text also creates italic text _ ```
